...
This source tree is **ScintiPix v0.3.0**. The Geant4 simulation and
...
- Release: [`v0.3.0`](https://github.com/lanl/ScintiPix/releases/tag/v0.3.0)
- Source archive: [`ScintiPix-0.3.0.tar.gz`](https://github.com/lanl/ScintiPix/releases/download/v0.3.0/ScintiPix-0.3.0.tar.gz)
- SHA-256 checksum: [`ScintiPix-0.3.0.tar.gz.sha256`](https://github.com/lanl/ScintiPix/releases/download/v0.3.0/ScintiPix-0.3.0.tar.gz.sha256)
