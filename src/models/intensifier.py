...
class IntensifierInputScreen(StrictModel):
...
class Intensifier(StrictModel):
    ...
    class PhotocathodeStage(StrictModel):
        ...
        def validate_qe_tables(self) -> "Intensifier.PhotocathodeStage":
    ...
    class PhosphorStage(StrictModel):
    ...
    photocathode: PhotocathodeStage = Field(default_factory=PhotocathodeStage)
    mcp: McpStage = Field(default_factory=McpStage)
    phosphor: PhosphorStage = Field(default_factory=PhosphorStage)
